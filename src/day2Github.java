public class day2Github {
    ...
    beklenen yer gonderir
    3-)git status --> Working space'deki stage area'daki durumu gosterir
    ...
    5-) git push --> Uzak repo'ya(yani remote --Github) gondermek icin kullandigimiz kod yalniz
